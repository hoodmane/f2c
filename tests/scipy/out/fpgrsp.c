...
/* Recursive Subroutine */ int fpgrsp_(integer *ifsu, integer *ifsv, integer *
	ifbu, integer *ifbv, integer *iback, doublereal *u, integer *mu, 
	doublereal *v, integer *mv, doublereal *r__, integer *mr, doublereal *
	dr, integer *iop0, integer *iop1, doublereal *tu, integer *nu, 
