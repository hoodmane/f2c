	...
	complex *workl, real *rwork, integer *ierr)
{
    ...
    extern /* Subroutine */ int csscal_(integer *, real *, complex *, integer 
	    *), clahqr_(logical *, logical *, integer *, integer *, integer *,
	    ...
	    complex *, integer *, complex *, integer *), arscnd_(real *);
    static integer logfil, ndigit;
    static logical select[1];
    extern /* Subroutine */ int claset_(char *, integer *, integer *, complex 
	    *, complex *, complex *, integer *), ctrevc_(char *, char *, 
...
/*     %-------------------------------% */
    ...
    if (msglvl > 2) {
	cmout_(&logfil, n, n, &h__[h_offset], ldh, &ndigit, "_neigh: Enterin"
...
/*     %----------------------------------------------------------% */
    ...
    if (msglvl > 1) {
	cvout_(&logfil, n, &bounds[1], &ndigit, "_neigh: last row of the Sch"
...
/* L10: */
	...
	cvout_(&logfil, n, &workl[1], &ndigit, "_neigh: Last row of the eige"
...
/*     %----------------------------% */
    ...
    if (msglvl > 2) {
	cvout_(&logfil, n, &ritz[1], &ndigit, "_neigh: The eigenvalues of H", 
		(ftnlen)28);
	cvout_(&logfil, n, &bounds[1], &ndigit, "_neigh: Ritz estimates for "
