...
/* Subroutine */ int idz_id2svd__(integer *m, integer *krank, doublecomplex *
	...
	doublecomplex *v, doublereal *s, integer *ier, doublecomplex *w)
{
    ...
    extern /* Subroutine */ int idz_id2svd0__(integer *, integer *, 
...
/* Subroutine */ int idz_id2svd0__(integer *m, integer *krank, doublecomplex *
	b, integer *n, integer *list, doublecomplex *proj, doublecomplex *u, 
	...
	*r2, doublecomplex *r3, integer *ind, integer *indt)
{
    ...
    extern /* Subroutine */ int idz_rearr__(integer *, integer *, integer *, 
	    integer *, doublecomplex *), idz_rinqr__(integer *, integer *, 
	    doublecomplex *, integer *, doublecomplex *), idz_matadj__(
	    integer *, integer *, doublecomplex *, doublecomplex *), 
	    idzr_qrpiv__(integer *, integer *, doublecomplex *, integer *, 
	    integer *, doublecomplex *);
    static integer ldr, ldu;
    extern /* Subroutine */ int idz_qmatmat__(integer *, integer *, integer *,
	     doublecomplex *, integer *, integer *, doublecomplex *, 
	    doublecomplex *);
    static integer info;
    static char jobz[1];
    static integer ldvt;
    extern /* Subroutine */ int idz_reconint__(integer *, integer *, integer *
	    , doublecomplex *, doublecomplex *), idz_matmulta__(integer *, 
...
/* Computing 2nd power */
    ...
    zgesdd_(jobz, krank, krank, &r3[r3_offset], &ldr, &s[1], &work[1], &ldu, &
	    ...
	    krank << 1) + 1], &work[i__4 * i__4 + 1], &info);
...
/* Subroutine */ int idz_matadj__(integer *m, integer *n, doublecomplex *a, 
	doublecomplex *aa)
{
    /* System generated locals */
...
/* Subroutine */ int idz_matmulta__(integer *l, integer *m, doublecomplex *a, 
...
/* Subroutine */ int idz_rearr__(integer *krank, integer *ind, integer *m, 
...
/* Subroutine */ int idz_rinqr__(integer *m, integer *n, doublecomplex *a, 
