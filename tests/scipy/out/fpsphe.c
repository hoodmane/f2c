...
/* Recursive Subroutine */ int fpsphe_(integer *iopt, integer *m, doublereal *
	teta, doublereal *phi, doublereal *r__, doublereal *w, doublereal *s, 
	...
	integer *nummer, doublereal *wrk, integer *lwrk, integer *ier)
{
    ...
    extern /* Recursive Subroutine */ int fpbspl_(doublereal *, integer *, 
	    ...
	    doublereal *, doublereal *, doublereal *, doublereal *), fprpsp_(
