...
/* Subroutine */ int idzr_svd__(integer *m, integer *n, doublecomplex *a, 
	...
	integer *ier, doublecomplex *r__)
{
    ...
    /* Local variables */
    static integer j, k;
    extern /* Subroutine */ int idz_adjer__(integer *, integer *, 
    ...
    static integer info;
    static char jobz[1];
    extern /* Subroutine */ int idz_permuter__(integer *, doublecomplex *, 
	    integer *, integer *, doublecomplex *);
    static integer lwork;
    extern /* Subroutine */ int idz_retriever__(integer *, integer *, 
...
/* Subroutine */ int idzp_svd__(integer *lw, doublereal *eps, integer *m, 
	...
	iv, integer *is, doublecomplex *w, integer *ier)
{
    ...
    static integer info;
    static char jobz[1];
    extern /* Subroutine */ int idz_realcomp__(integer *, doublecomplex *, 
	    doublecomplex *), idz_permuter__(integer *, doublecomplex *, 
	    integer *, integer *, doublecomplex *);
    static integer lwork;
    extern /* Subroutine */ int idz_retriever__(integer *, integer *, 
	    doublecomplex *, integer *, doublecomplex *);
...
/* Subroutine */ int idz_permuter__(integer *krank, integer *ind, integer *m, 
...
/* Subroutine */ int idz_retriever__(integer *m, integer *n, doublecomplex *a,
...
/* Subroutine */ int idz_adjer__(integer *m, integer *n, doublecomplex *a, 
	doublecomplex *aa)
{
    /* System generated locals */
