...
/* Subroutine */ int idzp_rid__(integer *lproj, doublereal *eps, integer *m, 
	...
	doublecomplex *proj, integer *ier)
{
    ...
    extern /* Subroutine */ int idz_findrank__(integer *, doublereal *, 
	    integer *, integer *, U_fp, doublecomplex *, doublecomplex *, 
	    doublecomplex *, doublecomplex *, integer *, doublecomplex *, 
	    integer *, doublecomplex *);
    static integer iwork, lwork;
    extern /* Subroutine */ int idz_adjointer__(integer *, integer *, 
	    doublecomplex *, doublecomplex *);
    static integer kranki;
    extern /* Subroutine */ int idzp_id__(doublereal *, integer *, integer *, 
...
/*       Find the rank of a. */
    ...
    lra = *lproj - lwork;
    idz_findrank__(&lra, eps, m, n, (U_fp)matveca, p1, p2, p3, p4, &kranki, &
...
/*       Take the adjoint of ra. */
    ...
    idz_adjointer__(n, &kranki, &proj[ira], &proj[ira + kranki * *n]);
...
/* k */
    idzp_id__(eps, &kranki, n, &proj[1], krank, &list[1], &proj[kranki * *n + 
	    1]);
...
/* Subroutine */ int idz_findrank__(integer *lra, doublereal *eps, integer *m,
	 integer *n, U_fp matveca, doublecomplex *p1, doublecomplex *p2, 
	...
	ra, integer *ier, doublecomplex *w)
{
    ...
    extern /* Subroutine */ int idz_findrank0__(integer *, doublereal *, 
	    integer *, integer *, U_fp, doublecomplex *, doublecomplex *, 
	    doublecomplex *, doublecomplex *, integer *, doublecomplex *, 
...
/*               Also, the algorithm used by this routine is randomized. */
    ...
    idz_findrank0__(lra, eps, m, n, (U_fp)matveca, p1, p2, p3, p4, krank, &ra[
...
/* Subroutine */ int idz_findrank0__(integer *lra, doublereal *eps, integer *
	...
	scal)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int id_srand__(integer *, doublecomplex *);
    static integer ifrescal;
    static doublecomplex residual;
    static integer k, m2;
    extern /* Subroutine */ int idz_house__(integer *, doublecomplex *, 
	    doublecomplex *, doublecomplex *, doublecomplex *), idz_crunch__(
	    integer *, integer *, doublecomplex *), idz_houseapp__(integer *, 
	    doublecomplex *, doublecomplex *, integer *, doublecomplex *, 
	    doublecomplex *);
...
/*       Loop until the relative residual is greater than eps, */
...
/*           Compute the Euclidean norm of y. */
	...
	for (k = 1; k <= i__1; ++k) {
	    i__2 = k;
	    d_cnjg(&z__3, &y[k]);
	    z__2.r = y[i__2].r * z__3.r - y[i__2].i * z__3.i, z__2.i = y[i__2]
		    .r * z__3.i + y[i__2].i * z__3.r;
...
/*           Apply the previous Householder transformations to y. */
	...
	for (k = 1; k <= i__1; ++k) {
	    i__2 = *n - k + 1;
	    idz_houseapp__(&i__2, &ra[((k << 1) + 2) * ra_dim1 + 1], &y[k], &
		    ifrescal, &scal[k], &y[k]);
	}
...
/* krank .gt. 0 */
    i__1 = *n - *krank;
    idz_house__(&i__1, &y[*krank + 1], &residual, &ra[((*krank + 1 << 1) + 2) 
    ...
    if (z_abs(&residual) > *eps * enorm && *krank < *m && *krank < *n) {
	goto L1000;
    }
...
/*       Delete the Householder vectors from the array ra. */
    ...
    idz_crunch__(n, krank, &ra[ra_offset]);
...
/* Subroutine */ int idz_crunch__(integer *n, integer *l, doublecomplex *a)
{
    /* System generated locals */
...
/* Subroutine */ int idz_adjointer__(integer *m, integer *n, doublecomplex *a,
	 doublecomplex *aa)
{
    /* System generated locals */
