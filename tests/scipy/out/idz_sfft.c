...
/* Subroutine */ int idz_ldiv__(integer *l, integer *n, integer *m)
{
...
/* Subroutine */ int idz_sffti__(integer *l, integer *ind, integer *n, 
	doublecomplex *wsave)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int idz_ldiv__(integer *, integer *, integer *);
...
/* Subroutine */ int idz_sfft__(integer *l, integer *ind, integer *n, 
