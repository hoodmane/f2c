...
/* Subroutine */ int idz_houseapp__(integer *n, doublecomplex *vn, 
...
/* Subroutine */ int idz_house__(integer *n, doublecomplex *x, doublecomplex *
...
/* Subroutine */ int idz_housemat__(integer *n, doublecomplex *vn, doublereal 
