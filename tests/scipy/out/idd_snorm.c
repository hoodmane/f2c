...
/* Subroutine */ int idd_snorm__(integer *m, integer *n, S_fp matvect, 
	...
	doublereal *u)
{
    ...
    static integer k;
    extern /* Subroutine */ int idd_enorm__(integer *, doublereal *, 
	    doublereal *);
    static integer it;
...
/* Subroutine */ int idd_enorm__(integer *n, doublereal *v, doublereal *enorm)
{
    /* System generated locals */
    integer i__1;
    doublereal d__1;
...
/* Subroutine */ int idd_diffsnorm__(integer *m, integer *n, U_fp matvect, 
	doublereal *p1t, doublereal *p2t, doublereal *p3t, doublereal *p4t, 
	...
	doublereal *snorm, doublereal *w)
{
    ...
    extern /* Subroutine */ int idd_diffsnorm0__(integer *, integer *, U_fp, 
...
/*       Allocate memory in w. */
    ...
    idd_diffsnorm0__(m, n, (U_fp)matvect, p1t, p2t, p3t, p4t, (U_fp)matvect2, 
...
/* Subroutine */ int idd_diffsnorm0__(integer *m, integer *n, S_fp matvect, 
	doublereal *p1t, doublereal *p2t, doublereal *p3t, doublereal *p4t, 
