...
/* Recursive Subroutine */ int fprank_(doublereal *a, doublereal *f, integer *
	n, integer *m, integer *na, doublereal *tol, doublereal *c__, 
	doublereal *sq, integer *rank, doublereal *aa, doublereal *ff, 
	doublereal *h__)
{
