...
/* Recursive Subroutine */ int lmdif_(S_fp fcn, integer *m, integer *n, 
	doublereal *x, doublereal *fvec, doublereal *ftol, doublereal *xtol, 
	doublereal *gtol, integer *maxfev, doublereal *epsfcn, doublereal *
	diag, integer *mode, doublereal *factor, integer *nprint, integer *
	info, integer *nfev, doublereal *fjac, integer *ldfjac, integer *ipvt,
	...
	doublereal *wa4)
{
    ...
    doublereal fnorm = {0}, gnorm = {0};
    extern /* Recursive Subroutine */ int fdjac2_(S_fp, integer *, integer *, 
	    doublereal *, doublereal *, doublereal *, integer *, integer *, 
	    doublereal *, doublereal *);
    doublereal pnorm = {0}, xnorm = {0}, fnorm1 = {0}, actred = {0}, dirder = 
	    {0}, epsmch = {0}, prered = {0};
