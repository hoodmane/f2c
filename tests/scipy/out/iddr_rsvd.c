...
/* Subroutine */ int iddr_rsvd__(integer *m, integer *n, U_fp matvect, 
	...
	doublereal *s, integer *ier, doublereal *w)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int iddr_rsvd0__(integer *, integer *, U_fp, 
...
/* Computing 2nd power */
    ...
    iddr_rsvd0__(m, n, (U_fp)matvect, p1t, p2t, p3t, p4t, (U_fp)matvec, p1, 
...
/* Subroutine */ int iddr_rsvd0__(integer *m, integer *n, U_fp matvect, 
	doublereal *p1t, doublereal *p2t, doublereal *p3t, doublereal *p4t, 
	U_fp matvec, doublereal *p1, doublereal *p2, doublereal *p3, 
	doublereal *p4, integer *krank, doublereal *u, doublereal *v, 
	...
	doublereal *col, doublereal *work)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int iddr_rid__(integer *, integer *, U_fp, 
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *,
	     integer *, doublereal *);
    static integer k;
...
/* Computing 2nd power */
    ...
    /* Function Body */
    iddr_rid__(m, n, (U_fp)matvect, p1t, p2t, p3t, p4t, krank, &list[1], &
	    work[1]);
...
/*       Convert the ID to an SVD. */
    ...
    idd_id2svd__(m, krank, &col[1], n, &list[1], &proj[1], &u[u_offset], &v[
