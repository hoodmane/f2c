...
/* Subroutine */ int dlu_c__(doublereal *p, doublereal *l, doublereal *u, 
...
/* Subroutine */ int zlu_c__(doublereal *p, doublecomplex *l, doublecomplex *
...
/* Subroutine */ int slu_c__(real *p, real *l, real *u, real *a, integer *m, 
...
/* Subroutine */ int clu_c__(real *p, complex *l, complex *u, complex *a, 
