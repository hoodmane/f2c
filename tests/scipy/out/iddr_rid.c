...
/* Subroutine */ int iddr_rid__(integer *m, integer *n, U_fp matvect, 
	...
	integer *krank, integer *list, doublereal *proj)
{
    ...
    extern /* Subroutine */ int iddr_ridall0__(integer *, integer *, U_fp, 
...
/*       Allocate memory in w. */
    ...
    iddr_ridall0__(m, n, (U_fp)matvect, p1, p2, p3, p4, krank, &list[1], &
...
/* Subroutine */ int iddr_ridall0__(integer *m, integer *n, S_fp matvect, 
	doublereal *p1, doublereal *p2, doublereal *p3, doublereal *p4, 
	...
	doublereal *y)
{
    ...
    extern /* Subroutine */ int iddr_id__(integer *, integer *, doublereal *, 
...
/* j */
    iddr_id__(&l, n, &r__[r_offset], krank, &list[1], &y[1]);
