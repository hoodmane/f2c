...
/* Subroutine */ int setulb_(integer *n, integer *m, doublereal *x, 
	...
	*g, doublereal *factr, doublereal *pgtol, doublereal *wa, integer *
	...
	integer *isave, doublereal *dsave, integer *maxls, ftnlen task_len, 
	ftnlen csave_len)
{
...
/* wa      8*m */
    ...
    mainlb_(n, m, &x[1], &l[1], &u[1], &nbd[1], f, &g[1], factr, pgtol, &wa[
	    ...
	    &iwa[*n + 1], &iwa[(*n << 1) + 1], task, iprint, csave, &lsave[1],
	     &isave[22], &dsave[1], maxls, (ftnlen)60, (ftnlen)60);
    return 0;
} /* setulb_ */
...
/* Subroutine */ int mainlb_(integer *n, integer *m, doublereal *x, 
	...
	*g, doublereal *factr, doublereal *pgtol, doublereal *ws, doublereal *
	...
	csave, logical *lsave, integer *isave, doublereal *dsave, integer *
	maxls, ftnlen task_len, ftnlen csave_len)
{
    /* Format strings */
    ...
    extern /* Subroutine */ int lnsrlb_(integer *, doublereal *, doublereal *,
	    ...
	    char *, integer *, doublereal *, integer *, ftnlen, ftnlen);
    static integer nintol;
    extern /* Subroutine */ int projgr_(integer *, doublereal *, doublereal *,
	     integer *, doublereal *, doublereal *, doublereal *);

    /* Fortran I/O blocks */
    static cilist io___54 = { 0, 6, 0, fmt_1002, 0 };
    static cilist io___55 = { 0, 6, 0, fmt_1001, 0 };
    static cilist io___57 = { 0, 0, 0, fmt_1005, 0 };
    static cilist io___59 = { 0, 0, 0, fmt_1006, 0 };
    static cilist io___60 = { 0, 0, 0, fmt_1005, 0 };
    static cilist io___62 = { 0, 0, 0, fmt_1008, 0 };
    static cilist io___66 = { 0, 6, 0, fmt_1004, 0 };
    static cilist io___67 = { 0, 0, 0, fmt_1007, 0 };
...
/*        Check the input arguments for errors. */
	...
	if (s_cmp(task, "ERROR", (ftnlen)5, (ftnlen)5) == 0) {
	    prn3lb_(n, &x[1], f, task, iprint, &info, &iter, &nfgv, &nintol, &
		    nskip, &nact, &sbgnrm, &c_b8, &nseg, word, &iback, &stp, &
		    xstep, &k, &cachyt, &sbtime, &lnscht, (ftnlen)60, (ftnlen)
		    3);
	    return 0;
	}
	prn1lb_(n, m, &l[1], &u[1], &x[1], iprint, &epsmch);
...
L666:
    lnsrlb_(n, &l[1], &u[1], &nbd[1], &x[1], f, &fold, &gd, &gdold, &g[1], &
	    ...
	    csave, &isave[22], &dsave[17], iprint, (ftnlen)60, (ftnlen)60);
...
/*        Print iteration information. */
	prn2lb_(n, &x[1], f, &g[1], iprint, &iter, &nfgv, &nact, &sbgnrm, &
		nseg, word, &iword, &iback, &stp, &xstep, (ftnlen)3);
	goto L1000;
    }
L777:
...
L999:
    timer_(&time2);
    time = time2 - time1;
    prn3lb_(n, &x[1], f, task, iprint, &info, &iter, &nfgv, &nintol, &nskip, &
	    nact, &sbgnrm, &time, &nseg, word, &iback, &stp, &xstep, &k, &
	    cachyt, &sbtime, &lnscht, (ftnlen)60, (ftnlen)3);
L1000:
	...
	logical *prjctd, logical *cnstnd, logical *boxed)
{
    ...
    static cilist io___74 = { 0, 6, 0, fmt_1001, 0 };
	...
	epsmch)
{
    ...
    static cilist io___96 = { 0, 6, 0, fmt_1010, 0 };
    static cilist io___101 = { 0, 6, 0, 0, 0 };
    static cilist io___108 = { 0, 6, 0, fmt_4011, 0 };
    static cilist io___109 = { 0, 6, 0, fmt_5010, 0 };
    static cilist io___110 = { 0, 6, 0, fmt_6010, 0 };
    static cilist io___113 = { 0, 6, 0, 0, 0 };
    static cilist io___118 = { 0, 6, 0, 0, 0 };
    static cilist io___119 = { 0, 6, 0, 0, 0 };
    static cilist io___120 = { 0, 6, 0, fmt_4010, 0 };
    static cilist io___121 = { 0, 6, 0, fmt_6010, 0 };
    static cilist io___122 = { 0, 6, 0, fmt_1010, 0 };
    static cilist io___123 = { 0, 6, 0, fmt_2010, 0 };
...
/* Subroutine */ int lnsrlb_(integer *n, doublereal *l, doublereal *u, 
	...
	csave, integer *isave, doublereal *dsave, integer *iprint, ftnlen 
	task_len, ftnlen csave_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___175 = { 0, 0, 0, 0, 0 };
...
/*                               Line search is impossible. */
		...
		do_lio(&c__9, &c__1, " ascent direction in projection gd = ", 
			(ftnlen)37);
		do_lio(&c__5, &c__1, (char *)&(*gd), (ftnlen)sizeof(
			doublereal));
		e_wsle();
	    }
	    *info = -4;
    ...
    dcsrch_(f, gd, stp, &c_b275, &c_b276, &c_b277, &c_b8, stpmx, csave, &
...
/* Subroutine */ int prn1lb_(integer *n, integer *m, doublereal *l, 
	doublereal *u, doublereal *x, integer *iprint, doublereal *epsmch)
{
    /* Format strings */
    ...
    /* Fortran I/O blocks */
    static cilist io___178 = { 0, 6, 0, fmt_7001, 0 };
    static cilist io___179 = { 0, 6, 0, 0, 0 };
    static cilist io___180 = { 0, 6, 0, fmt_1004, 0 };
    static cilist io___182 = { 0, 6, 0, fmt_1004, 0 };
    static cilist io___183 = { 0, 6, 0, fmt_1004, 0 };
...
/* Subroutine */ int prn2lb_(integer *n, doublereal *x, doublereal *f, 
	doublereal *g, integer *iprint, integer *iter, integer *nfgv, integer 
	*nact, doublereal *sbgnrm, integer *nseg, char *word, integer *iword, 
	integer *iback, doublereal *stp, doublereal *xstep, ftnlen word_len)
{
    /* Format strings */
    ...
    static cilist io___185 = { 0, 6, 0, fmt_2001, 0 };
...
/* Subroutine */ int prn3lb_(integer *n, doublereal *x, doublereal *f, char *
	task, integer *iprint, integer *info, integer *iter, integer *nfgv, 
	integer *nintol, integer *nskip, integer *nact, doublereal *sbgnrm, 
	doublereal *time, integer *nseg, char *word, integer *iback, 
	doublereal *stp, doublereal *xstep, integer *k, doublereal *cachyt, 
	doublereal *sbtime, doublereal *lnscht, ftnlen task_len, ftnlen 
	word_len)
{
    /* Format strings */
    ...
    static char fmt_9019[] = "(/,\002 Line search cannot locate an adequate "
	    "point after MAXLS\002,/,\002  function and gradient evaluations"
	    ".\002,/,\002  Previous x, f and g restored.\002,/,\002 Possible "
	    "causes: 1 error in function or gradient evaluation;\002,/,\002  "
    ...
    /* Fortran I/O blocks */
    static cilist io___191 = { 0, 6, 0, fmt_3003, 0 };
    static cilist io___192 = { 0, 6, 0, fmt_3004, 0 };
    static cilist io___193 = { 0, 6, 0, fmt_3005, 0 };
    static cilist io___194 = { 0, 6, 0, fmt_1004, 0 };
    static cilist io___196 = { 0, 6, 0, 0, 0 };
    static cilist io___197 = { 0, 6, 0, fmt_3009, 0 };
    static cilist io___198 = { 0, 0, 0, fmt_9011, 0 };
    static cilist io___199 = { 0, 0, 0, fmt_9012, 0 };
    static cilist io___200 = { 0, 0, 0, fmt_9013, 0 };
    static cilist io___201 = { 0, 0, 0, fmt_9014, 0 };
    static cilist io___202 = { 0, 0, 0, fmt_9015, 0 };
    static cilist io___203 = { 0, 0, 0, 0, 0 };
    static cilist io___204 = { 0, 6, 0, 0, 0 };
    static cilist io___205 = { 0, 0, 0, fmt_9018, 0 };
    static cilist io___206 = { 0, 0, 0, fmt_9019, 0 };
	...
	integer *iprint, integer *info)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___209 = { 0, 6, 0, fmt_1001, 0 };
    static cilist io___223 = { 0, 6, 0, 0, 0 };
    static cilist io___224 = { 0, 6, 0, 0, 0 };
    static cilist io___227 = { 0, 6, 0, fmt_1004, 0 };
