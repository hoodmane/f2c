...
/* Recursive Subroutine */ int fpcons_(integer *iopt, integer *idim, integer *
	m, doublereal *u, integer *mx, doublereal *x, doublereal *w, integer *
	ib, integer *ie, integer *k, doublereal *s, integer *nest, doublereal 
	*tol, integer *maxit, integer *k1, integer *k2, integer *n, 
	...
	doublereal *g, doublereal *q, integer *nrdata, integer *ier)
{
    ...
    integer i1 = {0}, i2 = {0}, i3 = {0}, j1 = {0}, j2 = {0};
    doublereal p1 = {0}, p2 = {0}, p3 = {0};
    integer j3 = {0}, l0 = {0}, n8 = {0}, jb = {0}, je = {0}, mb = {0}, me = {
	    0}, jj = {0}, li = {0}, lj = {0}, mm = {0}, nn = {0}, it = {0};
    doublereal ui = {0}, rn = {0}, wi = {0}, xi[10] = {}, fp0 = {0};
    integer nk1 = {0};
    doublereal acc = {0}, fac = {0};
    integer kbe = {0};
    doublereal one = {0}, cos__ = {0}, sin__ = {0};
    integer new__ = {0};
    doublereal piv = {0};
    ...
    integer npl1 = {0};
    doublereal half = {0};
    integer mmin = {0}, nmin = {0}, iter = {0}, nmax = {0};
    ...
    extern /* Recursive Subroutine */ int fpbspl_(doublereal *, integer *, 
	    ...
	    doublereal *, doublereal *, doublereal *, doublereal *), fpknot_(
	    doublereal *, integer *, doublereal *, integer *, doublereal *, 
	    integer *, integer *, integer *, integer *);

/* cc      implicit none   c XXX: mmnin/nmin variables on line 61 */
/*  .. */
/*  ..scalar arguments.. */
/*  ..array arguments.. */
/*  ..local scalars.. */
