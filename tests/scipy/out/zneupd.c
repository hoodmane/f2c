	...
	ftnlen which_len)
{
    ...
    extern /* Subroutine */ int zgeru_(integer *, integer *, doublecomplex *, 
	    ...
	    *, integer *, integer *, char *, ftnlen), ztrmm_(char *, char *, 
	    ...
	    doublecomplex *, integer *, doublecomplex *, integer *), zmout_(
    ...
    extern /* Subroutine */ int zunm2r_(char *, char *, integer *, integer *, 
	    ...
	    doublecomplex *, integer *, doublecomplex *, integer *);
    static integer logfil, mceupd, ndigit;
    extern /* Subroutine */ int zdscal_(integer *, doublereal *, 
	    doublecomplex *, integer *);
    static integer ishift, bounds;
    extern /* Subroutine */ int zlahqr_(logical *, logical *, integer *, 
	    integer *, integer *, doublecomplex *, integer *, doublecomplex *,
	     integer *, integer *, doublecomplex *, integer *, integer *), 
	    zlacpy_(char *, integer *, integer *, doublecomplex *, integer *, 
	    doublecomplex *, integer *), zlaset_(char *, integer *, integer *,
	     doublecomplex *, doublecomplex *, doublecomplex *, integer *);
    static integer msglvl, invsub, numcnv;
    extern /* Double Complex */ VOID wzdotc_(doublecomplex *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, integer *);
    static integer iuptri, outncv;
    extern /* Subroutine */ int zngets_(integer *, char *, integer *, integer 
	    *, doublecomplex *, doublecomplex *, ftnlen), ztrevc_(char *, 
	    char *, logical *, integer *, doublecomplex *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, integer *, integer *,
	     integer *, doublecomplex *, doublereal *, integer *), ztrsen_(
...
/*     %------------------------------------% */
    ...
    if (msglvl > 2) {
	zvout_(&logfil, ncv, &workl[irz], &ndigit, "_neupd: Ritz values pass"
		"ed in from _NAUPD.", (ftnlen)42);
	zvout_(&logfil, ncv, &workl[ibd], &ndigit, "_neupd: Ritz estimates p"
...
/*        %-------------------------------------% */
	...
	if (msglvl > 2) {
	    zvout_(&logfil, ncv, &workl[irz], &ndigit, "_neupd: Ritz values "
		    "after calling _NGETS.", (ftnlen)41);
	    zvout_(&logfil, ncv, &workl[bounds], &ndigit, "_neupd: Ritz valu"
...
/*        %-----------------------------------------------------------% */
	...
	if (msglvl > 2) {
	    ivout_(&logfil, &c__1, &numcnv, &ndigit, "_neupd: Number of spec"
		    "ified eigenvalues", (ftnlen)39);
	    ivout_(&logfil, &c__1, &nconv, &ndigit, "_neupd: Number of \"con"
...
/*        %-------------------------------------------------------% */
	...
	if (msglvl > 1) {
	    zvout_(&logfil, ncv, &workl[iheig], &ndigit, "_neupd: Eigenvalue"
		    "s of H", (ftnlen)24);
	    zvout_(&logfil, ncv, &workl[ihbds], &ndigit, "_neupd: Last row o"
		    "f the Schur vector matrix", (ftnlen)43);
	    if (msglvl > 3) {
		zmout_(&logfil, ncv, ncv, &workl[iuptri], &ldh, &ndigit, 
			"_neupd: The upper triangular matrix ", (ftnlen)36);
	    }
	}
...
/*           %-----------------------------------------------% */
		...
		*info = 1;
	    ...
	    if (msglvl > 2) {
		zvout_(&logfil, ncv, &workl[iheig], &ndigit, "_neupd: Eigenv"
			"alues of H--reordered", (ftnlen)35);
		if (msglvl > 3) {
		    zmout_(&logfil, ncv, ncv, &workl[iuptri], &ldq, &ndigit, 
...
/*                 %------------------------------------------% */
		...
		i__2 = j;
		wzdotc_(&z__1, &j, &workl[ihbds], &c__1, &workl[invsub + (j - 
			1) * ldq], &c__1);
...
/* L40: */
		...
		zcopy_(&nconv, &workl[invsub + *ncv - 1], &ldq, &workl[ihbds],
			 &c__1);
		zvout_(&logfil, &nconv, &workl[ihbds], &ndigit, "_neupd: Las"
			"t row of the eigenvector matrix for T", (ftnlen)48);
		if (msglvl > 3) {
		    zmout_(&logfil, ncv, ncv, &workl[invsub], &ldq, &ndigit, 
...
/* L60: */
	...
	zvout_(&logfil, &nconv, &d__[1], &ndigit, "_neupd: Untransformed Rit"
		"z values.", (ftnlen)34);
	zvout_(&logfil, &nconv, &workl[ihbds], &ndigit, "_neupd: Ritz estima"
		"tes of the untransformed Ritz values.", (ftnlen)56);
    } else if (msglvl > 1) {
	zvout_(&logfil, &nconv, &d__[1], &ndigit, "_neupd: Converged Ritz va"
		"lues.", (ftnlen)30);
	zvout_(&logfil, &nconv, &workl[ihbds], &ndigit, "_neupd: Associated "
