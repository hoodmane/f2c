...
/* Recursive Subroutine */ int fpclos_(integer *iopt, integer *idim, integer *
	m, doublereal *u, integer *mx, doublereal *x, doublereal *w, integer *
	k, doublereal *s, integer *nest, doublereal *tol, integer *maxit, 
	...
	doublereal *g2, doublereal *q, integer *nrdata, integer *ier)
{
    ...
    doublereal p = {0}, d1 = {0}, f1 = {0}, f2 = {0}, f3 = {0};
    integer i1 = {0}, i2 = {0}, i3 = {0};
    doublereal p1 = {0}, p2 = {0}, p3 = {0};
    integer j1 = {0}, j2 = {0}, k3 = {0}, l0 = {0}, l1 = {0}, l5 = {0}, m1 = {
	    0}, n7 = {0}, n8 = {0};
    doublereal h1[7] = {}, h2[6] = {};
    integer n10 = {0}, n11 = {0}, ij = {0}, ik = {0}, jj = {0}, jk = {0}, kk =
	     {0}, mm = {0}, it = {0};
    doublereal ui = {0}, wi = {0}, rn = {0}, xi[10] = {}, fp0 = {0};
    integer kk1 = {0}, nk1 = {0}, nk2 = {0};
    doublereal acc = {0}, fac = {0}, one = {0}, cos__ = {0}, per = {0}, sin__ 
	    = {0};
    integer new__ = {0};
    doublereal piv = {0};
