...
/* Recursive Subroutine */ int fpgrre_(integer *ifsx, integer *ifsy, integer *
	ifbx, integer *ifby, doublereal *x, integer *mx, doublereal *y, 
	integer *my, doublereal *z__, integer *mz, integer *kx, integer *ky, 
	doublereal *tx, integer *nx, doublereal *ty, integer *ny, doublereal *
	p, doublereal *c__, integer *nc, doublereal *fp, doublereal *fpx, 
