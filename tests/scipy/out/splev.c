...
/* Recursive Subroutine */ int splev_(doublereal *t, integer *n, doublereal *
	c__, integer *nc, integer *k, doublereal *x, doublereal *y, integer *
	m, integer *e, integer *ier)
{
    ...
    /* Local variables */
    doublereal h__[20] = {};
    integer i__ = {0}, j = {0}, l = {0}, k1 = {0}, l1 = {0}, k2 = {0};
    doublereal tb = {0};
    integer ll = {0};
    doublereal te = {0}, sp = {0};
    integer nk1 = {0};
    doublereal arg = {0};
...
/*  calling sequence: */
/*     call splev(t,n,c,nc,k,x,y,m,e,ier) */
