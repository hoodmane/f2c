...
/* Subroutine */ int iddr_asvd__(integer *m, integer *n, doublereal *a, 
	...
	doublereal *s, integer *ier)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int iddr_asvd0__(integer *, integer *, doublereal 
...
/* Computing 2nd power */
    ...
    iddr_asvd0__(m, n, &a[a_offset], krank, &w[iwinit], &u[u_offset], &v[
...
/* Subroutine */ int iddr_asvd0__(integer *m, integer *n, doublereal *a, 
	...
	doublereal *col, doublereal *work)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int iddr_aid__(integer *, integer *, doublereal *,
	     integer *, doublereal *, integer *, doublereal *), idd_id2svd__(
	    integer *, integer *, doublereal *, integer *, integer *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *,
	     doublereal *), idd_copycols__(integer *, integer *, doublereal *,
...
/* Computing 2nd power */
    ...
    /* Function Body */
    iddr_aid__(m, n, &a[a_offset], krank, &winit[1], &list[1], &proj[
	    proj_offset]);


/*       Collect together the columns of a indexed by list into col. */

    idd_copycols__(m, n, &a[a_offset], krank, &list[1], &col[1]);
