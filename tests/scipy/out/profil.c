...
/* Recursive Subroutine */ int profil_(integer *iopt, doublereal *tx, integer 
	*nx, doublereal *ty, integer *ny, doublereal *c__, integer *kx, 
	integer *ky, doublereal *u, integer *nu, doublereal *cu, integer *ier)
{
