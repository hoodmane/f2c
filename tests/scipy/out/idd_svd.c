...
/* Subroutine */ int iddr_svd__(integer *m, integer *n, doublereal *a, 
	...
	ier, doublereal *r__)
{
    ...
    extern /* Subroutine */ int idd_qmatmat__(integer *, integer *, integer *,
	    ...
	    idd_transer__(integer *, integer *, doublereal *, doublereal *);
    static integer iftranspose, info;
    static char jobz[1];
    static integer ldvt;
    extern /* Subroutine */ int idd_permuter__(integer *, doublereal *, 
	    integer *, integer *, doublereal *);
    static integer lwork;
    extern /* Subroutine */ int idd_retriever__(integer *, integer *, 
...
/* Subroutine */ int iddp_svd__(integer *lw, doublereal *eps, integer *m, 
...
/* Subroutine */ int idd_permuter__(integer *krank, integer *ind, integer *m, 
...
/* Subroutine */ int idd_retriever__(integer *m, integer *n, doublereal *a, 
...
/* Subroutine */ int idd_transer__(integer *m, integer *n, doublereal *a, 
	doublereal *at)
{
    /* System generated locals */
