...
/* Recursive Subroutine */ int dqk15_(D_fp f, doublereal *a, doublereal *b, 
	doublereal *result, doublereal *abserr, doublereal *resabs, 
	doublereal *resasc)
{
    /* Initialized data */

    doublereal wg[4] = { .129484966168869693270611432679082,
	    .27970539148927666790146777142378,
	    .381830050505118944950369775488975,
	    .417959183673469387755102040816327 };
    doublereal xgk[8] = { .991455371120812639206854697526329,
    ...
    doublereal wgk[8] = { .02293532201052922496373200805897,
