...
/* Recursive Subroutine */ int dqk31_(D_fp f, doublereal *a, doublereal *b, 
	...
	doublereal *resasc)
{
    ...
    doublereal xgk[16] = { .998002298693397060285172840152271,
    ...
    doublereal wgk[16] = { .005377479872923348987792051430128,
