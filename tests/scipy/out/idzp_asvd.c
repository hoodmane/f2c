...
/* Subroutine */ int idzp_asvd__(integer *lw, doublereal *eps, integer *m, 
	...
	integer *iu, integer *iv, integer *is, doublecomplex *w, integer *ier)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int idzp_aid__(doublereal *, integer *, integer *,
...
/*       ID a. */
    ...
    idzp_aid__(eps, m, n, &a[a_offset], &winit[1], krank, &w[ilist], &w[iproj]
	    );
...
/* Computing 2nd power */
	...
	idzp_asvd0__(m, n, &a[a_offset], krank, &w[ilist], &w[iproj], &w[iui],
...
/* k */
	idz_realcomplex__(&ls, &w[isi], &w[*is]);
	...
	doublecomplex *work)
{
    ...
    extern /* Subroutine */ int idz_id2svd__(integer *, integer *, 
	    ...
	    doublecomplex *), idz_copycols__(integer *, integer *, 
	    doublecomplex *, integer *, integer *, doublecomplex *);
...
/* Computing 2nd power */
    ...
    /* Function Body */
    idz_copycols__(m, n, &a[a_offset], krank, &list[1], &col[col_offset]);


/*       Convert the ID to an SVD. */

    idz_id2svd__(m, krank, &col[col_offset], n, &list[1], &proj[proj_offset], 
