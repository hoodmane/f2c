...
/* Recursive Subroutine */ int dqk61_(D_fp f, doublereal *a, doublereal *b, 
	doublereal *result, doublereal *abserr, doublereal *resabs, 
	doublereal *resasc)
{
    /* Initialized data */

    doublereal wg[15] = { .007968192496166605615465883474674,
    ...
    doublereal xgk[31] = { .999484410050490637571325895705811,
    ...
    doublereal wgk[31] = { .00138901369867700762455159122676,
    ...
    /* Local variables */
    integer j = {0};
    doublereal fc = {0}, fv1[30] = {}, fv2[30] = {};
    integer jtw = {0};
    doublereal resg = {0}, resk = {0}, fsum = {0}, fval1 = {0}, fval2 = {0};
    integer jtwm1 = {0};
    doublereal dabsc = {0}, hlgth = {0}, centr = {0}, reskh = {0}, uflow = {0}
	    ;
