...
/* Recursive Subroutine */ int fptrnp_(integer *m, integer *mm, integer *idim,
	 integer *n, integer *nr, doublereal *sp, doublereal *p, doublereal *
	b, doublereal *z__, doublereal *a, doublereal *q, doublereal *right)
{
    ...
    /* Local variables */
    doublereal h__[7] = {};
    integer i__ = {0}, j = {0}, l = {0}, i2 = {0}, i3 = {0}, m2 = {0}, m3 = {
	    0}, n1 = {0}, n4 = {0}, ii = {0}, jj = {0}, it = {0}, mid = {0}, 
	    nmd = {0};
    doublereal one = {0}, cos__ = {0}, sin__ = {0}, piv = {0}, pinv = {0};
    integer irot = {0}, iband = {0}, nrold = {0}, number = {0};
