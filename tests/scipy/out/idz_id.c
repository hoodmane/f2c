...
/* Subroutine */ int idzp_id__(doublereal *eps, integer *m, integer *n, 
	doublecomplex *a, integer *krank, integer *list, doublereal *rnorms)
{
    ...
    /* Local variables */
    static integer k;
    extern /* Subroutine */ int idzp_qrpiv__(doublereal *, integer *, integer 
	    *, doublecomplex *, integer *, integer *, doublereal *), 
	    idz_lssolve__(integer *, integer *, doublecomplex *, integer *);
...
/*       QR decompose a. */
    ...
    /* Function Body */
    idzp_qrpiv__(eps, m, n, &a[a_offset], krank, &list[1], &rnorms[1]);
...
/*       Backsolve for proj, storing it at the beginning of a. */
    ...
    if (*krank > 0) {
	idz_lssolve__(m, n, &a[a_offset], krank);
    }
...
/* Subroutine */ int idzr_id__(integer *m, integer *n, doublecomplex *a, 
	integer *krank, integer *list, doublereal *rnorms)
{
    ...
    extern /* Subroutine */ int idzr_qrpiv__(integer *, integer *, 
	    doublecomplex *, integer *, integer *, doublereal *), 
	    idz_lssolve__(integer *, integer *, doublecomplex *, integer *);
    static integer iswap;
...
/*       QR decompose a. */
    ...
    /* Function Body */
    idzr_qrpiv__(m, n, &a[a_offset], krank, &list[1], &rnorms[1]);
...
/* Subroutine */ int idz_reconid__(integer *m, integer *krank, doublecomplex *
...
/* Subroutine */ int idz_lssolve__(integer *m, integer *n, doublecomplex *a, 
	integer *krank)
{
    /* System generated locals */
    ...
    extern /* Subroutine */ int idz_moverup__(integer *, integer *, integer *,
	     doublecomplex *);
...
/* k */
    idz_moverup__(m, n, krank, &a[a_offset]);
...
/* Subroutine */ int idz_moverup__(integer *m, integer *n, integer *krank, 
	doublecomplex *a)
{
    /* System generated locals */
...
/* Subroutine */ int idz_getcols__(integer *m, integer *n, S_fp matvec, 
...
/* Subroutine */ int idz_reconint__(integer *n, integer *list, integer *krank,
...
/* Subroutine */ int idz_copycols__(integer *m, integer *n, doublecomplex *a, 
