...
/* Recursive Subroutine */ int splder_(doublereal *t, integer *n, doublereal *
	c__, integer *nc, integer *k, integer *nu, doublereal *x, doublereal *
	y, integer *m, integer *e, doublereal *wrk, integer *ier)
{
    ...
    /* Local variables */
    doublereal h__[6] = {};
    integer i__ = {0}, j = {0}, l = {0}, k1 = {0}, k2 = {0}, l1 = {0}, l2 = {
	    0}, k3 = {0};
    doublereal ak = {0};
    integer kk = {0};
    doublereal tb = {0};
...
/*  calling sequence: */
/*     call splder(t,n,c,nc,k,nu,x,y,m,e,wrk,ier) */

/*  input parameters: */
/*    t    : array,length n, which contains the position of the knots. */
/*    n    : integer, giving the total number of knots of s(x). */
/*    c    : array,length nc, containing the b-spline coefficients. */
/*           the length of the array, nc >= n - k -1. */
/*           further coefficients are ignored. */
