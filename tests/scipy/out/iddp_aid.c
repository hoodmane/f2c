...
/* Subroutine */ int iddp_aid__(doublereal *eps, integer *m, integer *n, 
	...
	doublereal *proj)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int iddp_aid0__(doublereal *, integer *, integer *
	    , doublereal *, integer *, integer *, doublereal *, doublereal *),
	     iddp_aid1__(doublereal *, integer *, integer *, integer *, 
	    doublereal *, integer *, integer *, doublereal *);
    static integer n2;
    extern /* Subroutine */ int idd_estrank__(doublereal *, integer *, 
...
/*       Find the rank of a. */
    ...
    idd_estrank__(eps, m, n, &a[a_offset], &work[1], &kranki, &proj[1]);


    if (kranki == 0) {
	iddp_aid0__(eps, m, n, &a[a_offset], krank, &list[1], &proj[1], &proj[
		*m * *n + 1]);
    }

    if (kranki != 0) {
	iddp_aid1__(eps, &n2, n, &kranki, &proj[1], krank, &list[1], &proj[n2 
		* *n + 1]);
    }
...
/* Subroutine */ int iddp_aid0__(doublereal *eps, integer *m, integer *n, 
	...
	doublereal *rnorms)
{
    ...
    /* Local variables */
    static integer j, k;
    extern /* Subroutine */ int iddp_id__(doublereal *, integer *, integer *, 
	    doublereal *, integer *, integer *, doublereal *);
...
/* k */
    iddp_id__(eps, m, n, &proj[proj_offset], krank, &list[1], &rnorms[1]);
...
/* Subroutine */ int iddp_aid1__(doublereal *eps, integer *n2, integer *n, 
...
/* k */
    iddp_id__(eps, kranki, n, &proj[1], krank, &list[1], &rnorms[1]);
...
/* Subroutine */ int idd_estrank__(doublereal *eps, integer *m, integer *n, 
	doublereal *a, doublereal *w, integer *krank, doublereal *ra)
{
    ...
    extern /* Subroutine */ int idd_estrank0__(doublereal *, integer *, 
...
/*       Allocate memory in ra. */
    ...
    idd_estrank0__(eps, m, n, &a[a_offset], &w[1], &n2, krank, &ra[ira], &ra[
	    irat], &ra[iscal]);
...
/* Subroutine */ int idd_estrank0__(doublereal *eps, integer *m, integer *n, 
	...
	*ra, doublereal *rat, doublereal *scal)
{
    ...
    static integer j, k;
    extern /* Subroutine */ int idd_house__(integer *, doublereal *, 
	    doublereal *, doublereal *, doublereal *);
    static doublereal ss;
    extern /* Subroutine */ int idd_houseapp__(integer *, doublereal *, 
	    doublereal *, integer *, doublereal *, doublereal *);
    static doublereal ssmax;
    static integer nulls;
    extern /* Subroutine */ int idd_frm__(integer *, integer *, doublereal *, 
	    doublereal *, doublereal *), idd_atransposer__(integer *, integer 
...
/*       Apply the random matrix to every column of a, obtaining ra. */
    ...
    i__1 = *n;
    for (k = 1; k <= i__1; ++k) {
	idd_frm__(m, n2, &w[1], &a[k * a_dim1 + 1], &ra[k * ra_dim1 + 1]);
    }
...
/* k */
    idd_atransposer__(n2, n, &ra[ra_offset], &rat[rat_offset]);
...
/*           to rat(:,krank+1). */
	...
	for (k = 1; k <= i__1; ++k) {
	    i__2 = *n - k + 1;
	    idd_houseapp__(&i__2, &rat[k * rat_dim1 + 1], &rat[k + (*krank + 
...
/* krank .gt. 0 */
    i__1 = *n - *krank;
    idd_house__(&i__1, &rat[*krank + 1 + (*krank + 1) * rat_dim1], &residual, 
	    &rat[(*krank + 1) * rat_dim1 + 1], &scal[*krank + 1]);
    residual = abs(residual);


    ++(*krank);
    if (residual <= *eps * sqrt(ssmax)) {
	++nulls;
    }
...
/* Subroutine */ int idd_atransposer__(integer *m, integer *n, doublereal *a, 
	doublereal *at)
{
    /* System generated locals */
