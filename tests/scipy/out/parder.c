...
/* Recursive Subroutine */ int parder_(doublereal *tx, integer *nx, 
	doublereal *ty, integer *ny, doublereal *c__, integer *kx, integer *
	ky, integer *nux, integer *nuy, doublereal *x, integer *mx, 
	doublereal *y, integer *my, doublereal *z__, doublereal *wrk, integer 
	*lwrk, integer *iwrk, integer *kwrk, integer *ier)
{
    /* System generated locals */
    integer i__1, i__2, i__3;

    /* Local variables */
    integer i__ = {}, j = {}, m = {}, l1 = {}, l2 = {}, m0 = {}, m1 = {};
    doublereal ak = {};
    integer nc = {}, lx = {}, ly = {}, kx1 = {}, ky1 = {};
    doublereal fac = {};
