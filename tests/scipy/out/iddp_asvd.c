...
/* Subroutine */ int iddp_asvd__(integer *lw, doublereal *eps, integer *m, 
	...
	*iu, integer *iv, integer *is, doublereal *w, integer *ier)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int iddp_aid__(doublereal *, integer *, integer *,
	     doublereal *, doublereal *, integer *, doublereal *, doublereal *
	    );
    static integer k;
    extern /* Subroutine */ int iddp_asvd0__(integer *, integer *, doublereal 
...
/* Subroutine */ int iddp_asvd0__(integer *m, integer *n, doublereal *a, 
	...
	doublereal *work)
{
    ...
    extern /* Subroutine */ int idd_id2svd__(integer *, integer *, doublereal 
	    *, integer *, integer *, doublereal *, doublereal *, doublereal *,
	     doublereal *, integer *, doublereal *), idd_copycols__(integer *,
