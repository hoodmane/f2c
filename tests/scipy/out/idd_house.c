...
/*       needed to apply the Householder transformation reflecting */
...
/* Subroutine */ int idd_houseapp__(integer *n, doublereal *vn, doublereal *u,
...
/* Subroutine */ int idd_house__(integer *n, doublereal *x, doublereal *rss, 
...
/* Subroutine */ int idd_housemat__(integer *n, doublereal *vn, doublereal *
	scal, doublereal *h__)
{
    /* System generated locals */
