	...
	real *shifti, ftnlen which_len)
{
    ...
    static integer logfil, ndigit, mngets, msglvl;
    static real tngets;
...
/*        %-------------------------------------------------------% */
    ...
    if (msglvl > 0) {
	ivout_(&logfil, &c__1, kev, &ndigit, "_ngets: KEV is", (ftnlen)14);
	ivout_(&logfil, &c__1, np, &ndigit, "_ngets: NP is", (ftnlen)13);
	i__1 = *kev + *np;
	svout_(&logfil, &i__1, &ritzr[1], &ndigit, "_ngets: Eigenvalues of c"
		"urrent H matrix -- real part", (ftnlen)52);
	i__1 = *kev + *np;
	svout_(&logfil, &i__1, &ritzi[1], &ndigit, "_ngets: Eigenvalues of c"
		"urrent H matrix -- imag part", (ftnlen)52);
	i__1 = *kev + *np;
	svout_(&logfil, &i__1, &bounds[1], &ndigit, "_ngets: Ritz estimates "
