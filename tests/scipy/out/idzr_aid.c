...
/* Subroutine */ int idzr_aid__(integer *m, integer *n, doublecomplex *a, 
	integer *krank, doublecomplex *w, integer *list, doublecomplex *proj)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int idzr_aid0__(integer *, integer *, 
...
/*       Allocate memory in w. */
    ...
    idzr_aid0__(m, n, &a[a_offset], krank, &w[iw], &list[1], &proj[1], &w[ir])
	    ;
...
/* Subroutine */ int idzr_aid0__(integer *m, integer *n, doublecomplex *a, 
	integer *krank, doublecomplex *w, integer *list, doublecomplex *proj, 
	doublecomplex *r__)
{
    /* System generated locals */
    ...
    /* Local variables */
    extern /* Subroutine */ int idz_sfrm__(integer *, integer *, integer *, 
	    doublecomplex *, doublecomplex *, doublecomplex *);
    static integer k, l, n2, mn, lproj;
    extern /* Subroutine */ int idzr_copyzarr__(integer *, doublecomplex *, 
	    doublecomplex *), idzr_id__(integer *, integer *, doublecomplex *,
...
/*         Apply the random matrix. */
	...
	i__1 = *n;
	for (k = 1; k <= i__1; ++k) {
	    idz_sfrm__(&l, m, &n2, &w[11], &a[k * a_dim1 + 1], &r__[k * 
		    r_dim1 + 1]);
	}
...
/* k */
	idzr_id__(&l, n, &r__[r_offset], krank, &list[1], &w[*m * 20 + 81]);

/*         Retrieve proj from r. */

	lproj = *krank * (*n - *krank);
	idzr_copyzarr__(&lproj, &r__[r_offset], &proj[proj_offset]);
...
/*         ID a directly. */
	...
	mn = *m * *n;
	idzr_copyzarr__(&mn, &a[a_offset], &r__[r_offset]);
	idzr_id__(m, n, &r__[r_offset], krank, &list[1], &w[*m * 20 + 81]);
...
/* Subroutine */ int idzr_copyzarr__(integer *n, doublecomplex *a, 
	doublecomplex *b)
{
    /* System generated locals */
...
/* Subroutine */ int idzr_aidi__(integer *m, integer *n, integer *krank, 
	doublecomplex *w)
{
    static integer l, n2;
    extern /* Subroutine */ int idz_sfrmi__(integer *, integer *, integer *, 
	    doublecomplex *);
