...
/* Recursive Subroutine */ int dqk41_(D_fp f, doublereal *a, doublereal *b, 
	doublereal *result, doublereal *abserr, doublereal *resabs, 
	doublereal *resasc)
{
    /* Initialized data */

    doublereal wg[10] = { .017614007139152118311861962351853,
    ...
    doublereal xgk[21] = { .998859031588277663838315576545863,
    ...
    doublereal wgk[21] = { .003073583718520531501218293246031,
