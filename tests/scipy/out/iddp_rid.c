...
/* Subroutine */ int iddp_rid__(integer *lproj, doublereal *eps, integer *m, 
	...
	integer *ier)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int idd_rtransposer__(integer *, integer *, 
	    doublereal *, doublereal *);
    static integer k, lw, ira, lra;
    extern /* Subroutine */ int idd_findrank__(integer *, doublereal *, 
...
/*       Find the rank of a. */
    ...
    lra = *lproj - lwork;
    idd_findrank__(&lra, eps, m, n, (U_fp)matvect, p1, p2, p3, p4, &kranki, &
...
/*       Transpose ra. */
    ...
    idd_rtransposer__(n, &kranki, &proj[ira], &proj[ira + kranki * *n]);
...
/* k */
    iddp_id__(eps, &kranki, n, &proj[1], krank, &list[1], &proj[kranki * *n + 
	    1]);
...
/* Subroutine */ int idd_findrank__(integer *lra, doublereal *eps, integer *m,
	 integer *n, U_fp matvect, doublereal *p1, doublereal *p2, doublereal 
	...
	doublereal *w)
{
    ...
    extern /* Subroutine */ int idd_findrank0__(integer *, doublereal *, 
	    integer *, integer *, U_fp, doublereal *, doublereal *, 
	    doublereal *, doublereal *, integer *, doublereal *, integer *, 
...
/*               Also, the algorithm used by this routine is randomized. */
    ...
    idd_findrank0__(lra, eps, m, n, (U_fp)matvect, p1, p2, p3, p4, krank, &ra[
...
/* Subroutine */ int idd_findrank0__(integer *lra, doublereal *eps, integer *
	...
	integer *ier, doublereal *x, doublereal *y, doublereal *scal)
{
    ...
    extern /* Subroutine */ int idd_house__(integer *, doublereal *, 
	    doublereal *, doublereal *, doublereal *), idd_crunch__(integer *,
	     integer *, doublereal *), idd_houseapp__(integer *, doublereal *,
...
/*           Apply the previous Householder transformations to y. */
	...
	for (k = 1; k <= i__1; ++k) {
	    i__2 = *n - k + 1;
	    idd_houseapp__(&i__2, &ra[((k << 1) + 2) * ra_dim1 + 1], &y[k], &
		    ifrescal, &scal[k], &y[k]);
	}
...
/* krank .gt. 0 */
    i__1 = *n - *krank;
    idd_house__(&i__1, &y[*krank + 1], &residual, &ra[((*krank + 1 << 1) + 2) 
    ...
    if (residual > *eps * enorm && *krank < *m && *krank < *n) {
	goto L1000;
    }
...
/*       Delete the Householder vectors from the array ra. */
    ...
    idd_crunch__(n, krank, &ra[ra_offset]);
...
/* Subroutine */ int idd_crunch__(integer *n, integer *l, doublereal *a)
{
    /* System generated locals */
...
/* Subroutine */ int idd_rtransposer__(integer *m, integer *n, doublereal *a, 
	doublereal *at)
{
    /* System generated locals */
