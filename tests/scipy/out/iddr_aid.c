...
/* Subroutine */ int iddr_aid__(integer *m, integer *n, doublereal *a, 
	integer *krank, doublereal *w, integer *list, doublereal *proj)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int iddr_aid0__(integer *, integer *, doublereal *
...
/*       Allocate memory in w. */
    ...
    iddr_aid0__(m, n, &a[a_offset], krank, &w[iw], &list[1], &proj[1], &w[ir])
	    ;
...
/* Subroutine */ int iddr_aid0__(integer *m, integer *n, doublereal *a, 
	integer *krank, doublereal *w, integer *list, doublereal *proj, 
	doublereal *r__)
{
    /* System generated locals */
    ...
    /* Local variables */
    extern /* Subroutine */ int idd_sfrm__(integer *, integer *, integer *, 
	    doublereal *, doublereal *, doublereal *);
    static integer k, l, n2, mn, lproj;
    extern /* Subroutine */ int iddr_copydarr__(integer *, doublereal *, 
	    doublereal *), iddr_id__(integer *, integer *, doublereal *, 
...
/*         Apply the random matrix. */
	...
	i__1 = *n;
	for (k = 1; k <= i__1; ++k) {
	    idd_sfrm__(&l, m, &n2, &w[11], &a[k * a_dim1 + 1], &r__[k * 
		    r_dim1 + 1]);
	}
...
/* k */
	iddr_id__(&l, n, &r__[r_offset], krank, &list[1], &w[*m * 26 + 101]);

/*         Retrieve proj from r. */

	lproj = *krank * (*n - *krank);
	iddr_copydarr__(&lproj, &r__[r_offset], &proj[proj_offset]);
...
/*         ID a directly. */
	...
	mn = *m * *n;
	iddr_copydarr__(&mn, &a[a_offset], &r__[r_offset]);
	iddr_id__(m, n, &r__[r_offset], krank, &list[1], &w[*m * 26 + 101]);
...
/* Subroutine */ int iddr_copydarr__(integer *n, doublereal *a, doublereal *b)
{
    /* System generated locals */
    integer i__1;
...
/* Subroutine */ int iddr_aidi__(integer *m, integer *n, integer *krank, 
	doublereal *w)
{
    static integer l;
    extern /* Subroutine */ int idd_sfrmi__(integer *, integer *, integer *, 
	    doublereal *);
    static integer n2;
