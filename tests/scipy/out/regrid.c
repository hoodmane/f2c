...
/* Recursive Subroutine */ int regrid_(integer *iopt, integer *mx, doublereal 
	*x, integer *my, doublereal *y, doublereal *z__, doublereal *xb, 
	doublereal *xe, doublereal *yb, doublereal *ye, integer *kx, integer *
	ky, doublereal *s, integer *nxest, integer *nyest, integer *nx, 
...
L50:
    ...
    if (*s == 0.f && (*nxest < *mx + kx1 || *nyest < *my + ky1)) {
	goto L70;
    }
    *ier = 0;
