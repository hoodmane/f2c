...
/*     %------------------------------------% */
	...
	*info = 3;
	...
	dvout_(&logfil, &np, &workl[ritzr], &ndigit, "_naupd: Real part of t"
		"he final Ritz values", (ftnlen)42);
	dvout_(&logfil, &np, &workl[ritzi], &ndigit, "_naupd: Imaginary part"
		" of the final Ritz values", (ftnlen)47);
	dvout_(&logfil, &np, &workl[bounds], &ndigit, "_naupd: Associated Ri"
