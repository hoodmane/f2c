...
/* Recursive Subroutine */ int fppola_(integer *iopt1, integer *iopt2, 
	integer *iopt3, integer *m, doublereal *u, doublereal *v, doublereal *
	z__, doublereal *w, D_fp rad, doublereal *s, integer *nuest, integer *
	nvest, doublereal *eta, doublereal *tol, integer *maxit, integer *ib1,
	...
	integer *lwrk, integer *ier)
{
    ...
    doublereal p = {0}, r__ = {0}, c1 = {0}, c2 = {0}, c3 = {0}, c4 = {0}, f1 
	    = {0}, f2 = {0}, f3 = {0};
    integer i1 = {0}, i2 = {0}, i3 = {0}, j1 = {0}, j2 = {0}, l1 = {0};
    doublereal p1 = {0}, p2 = {0}, p3 = {0};
    integer l2 = {0}, l3 = {0}, l4 = {0};
    doublereal u2 = {0}, u3 = {0};
    integer la = {0};
    doublereal co = {0};
    integer ii = {0}, lf = {0}, il = {0};
    doublereal pi = {0};
    integer in = {0};
    doublereal si = {0};
    integer lh = {0}, ll = {0};
    doublereal hu[4] = {}, wi = {0}, rn = {0};
    integer lu = {0};
    doublereal sq = {0}, zi = {0};
    integer lv = {0};
    doublereal hv[4] = {}, uu = {0}, pi2 = {0};
    integer nr1 = {0}, nu4 = {0}, nv4 = {0};
    doublereal acc = {0}, fac = {0}, arg = {0}, one = {0}, hui = {0}, huj = {
	    0}, eps = {0}, ten = {0};
    integer jlu = {0};
    doublereal piv = {0};
    integer num = {0}, nrr = {0};
    doublereal fac1 = {0}, fac2 = {0}, two = {0};
    integer nvv = {0}, nuu = {0}, ich1 = {0}, ich3 = {0};
    doublereal con1 = {0}, con4 = {0}, con9 = {0};
    integer num1 = {0};
    doublereal half = {0};
    integer ncof = {0};
    doublereal dmax__ = {0};
    integer ipar = {0}, nreg = {0}, rank = {0}, iter = {0};
    doublereal fpms = {0}, pinv = {0};
    integer irot = {0}, jrot = {0}, ipar1 = {0}, iband = {0}, ncoff = {0};
    doublereal sigma = {0}, three = {0}, fpmax = {0}, ratio = {0};
    integer numin = {0}, nvmin = {0}, nrint = {0};
    doublereal store = {0};
    integer iband3 = {0}, iband4 = {0}, lwest = {0}, iband1 = {0};
    extern /* Recursive Subroutine */ int fpback_(doublereal *, doublereal *, 
	    integer *, integer *, doublereal *, integer *), fpdisc_(
	    doublereal *, integer *, integer *, doublereal *, integer *), 
	    fporde_(doublereal *, doublereal *, integer *, integer *, integer 
    ...
    extern /* Recursive Subroutine */ int fpbspl_(doublereal *, integer *, 
	    integer *, doublereal *, integer *, doublereal *), fprota_(
	    doublereal *, doublereal *, doublereal *, doublereal *), fpgivs_(
	    doublereal *, doublereal *, doublereal *, doublereal *), fprppo_(
