	...
	doublereal *asumi, doublereal *bsumr, doublereal *bsumi)
{
    ...
    static doublereal zetai;
    extern /* Subroutine */ int azlog_(doublereal *, doublereal *, doublereal 
	    *, doublereal *, integer *);
    static doublereal ptfni, sumai, sumbi, zetar, ptfnr, razth, sumar, sumbr, 
	    rzthi;
    extern doublereal d1mach_(integer *);
    static doublereal rzthr, rtzti, rtztr, przthi;
    extern /* Subroutine */ int azsqrt_(doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    static doublereal przthr;
...
L20:
    ...
    *argr = zetar * fn23;
    *argi = zetai * fn23;
    azsqrt_(&sumar, &sumai, &zar, &zai);
    azsqrt_(&w2r, &w2i, &str, &sti);
    *zeta2r = str * *fnu;
    *zeta2i = sti * *fnu;
