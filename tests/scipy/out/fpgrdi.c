...
/* Recursive Subroutine */ int fpgrdi_(integer *ifsu, integer *ifsv, integer *
	ifbu, integer *ifbv, integer *iback, doublereal *u, integer *mu, 
	doublereal *v, integer *mv, doublereal *z__, integer *mz, doublereal *
	dz, integer *iop0, integer *iop1, doublereal *tu, integer *nu, 
	doublereal *tv, integer *nv, doublereal *p, doublereal *c__, integer *
	nc, doublereal *sq, doublereal *fp, doublereal *fpu, doublereal *fpv, 
	...
	integer *nrv)
{
    ...
    integer ic = {0};
    doublereal co = {0};
    integer ii = {0}, ij = {0}, ik = {0}, iq = {0};
    doublereal si = {0};
    integer it = {0}, jj = {0}, jk = {0}, iz = {0};
    doublereal dz1 = {0}, dz2 = {0}, dz3 = {0};
    integer nu4 = {0}, nv4 = {0}, nu7 = {0}, nu8 = {0}, nu9 = {0}, nv7 = {0}, 
	    nv8 = {0};
    doublereal fac = {0}, arg = {0}, one = {0};
    integer nv11 = {0};
    doublereal piv = {0}, fac0 = {0};
    integer mvv = {0}, nuu = {0};
    doublereal half = {0};
    ...
    extern /* Recursive Subroutine */ int fpcyt1_(doublereal *, integer *, 
	    ...
	    doublereal *, integer *, integer *), fpdisc_(doublereal *, 
