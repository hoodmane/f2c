...
/* Recursive Subroutine */ int fpperi_(integer *iopt, doublereal *x, 
	doublereal *y, doublereal *w, integer *m, integer *k, doublereal *s, 
	integer *nest, doublereal *tol, integer *maxit, integer *k1, integer *
	k2, integer *n, doublereal *t, doublereal *c__, doublereal *fp, 
	doublereal *fpint, doublereal *z__, doublereal *a1, doublereal *a2, 
	doublereal *b, doublereal *g1, doublereal *g2, doublereal *q, integer 
	*nrdata, integer *ier)
{
