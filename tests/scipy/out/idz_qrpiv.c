...
/* Subroutine */ int idz_permmult__(integer *m, integer *ind, integer *n, 
	integer *indprod)
{
...
/* Subroutine */ int idz_qinqr__(integer *m, integer *n, doublecomplex *a, 
...
/* Subroutine */ int idz_qmatvec__(integer *ifadjoint, integer *m, integer *n,
...
/* Subroutine */ int idz_qmatmat__(integer *ifadjoint, integer *m, integer *n,
...
/* Subroutine */ int idzp_qrpiv__(doublereal *eps, integer *m, integer *n, 
...
/* Subroutine */ int idzr_qrpiv__(integer *m, integer *n, doublecomplex *a, 
