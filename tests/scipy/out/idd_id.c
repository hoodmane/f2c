...
/* Subroutine */ int iddp_id__(doublereal *eps, integer *m, integer *n, 
	doublereal *a, integer *krank, integer *list, doublereal *rnorms)
{
    ...
    /* Local variables */
    static integer k;
    extern /* Subroutine */ int iddp_qrpiv__(doublereal *, integer *, integer 
	    *, doublereal *, integer *, integer *, doublereal *), 
	    idd_lssolve__(integer *, integer *, doublereal *, integer *);
...
/*       QR decompose a. */
    ...
    /* Function Body */
    iddp_qrpiv__(eps, m, n, &a[a_offset], krank, &list[1], &rnorms[1]);
...
/*       Backsolve for proj, storing it at the beginning of a. */
    ...
    if (*krank > 0) {
	idd_lssolve__(m, n, &a[a_offset], krank);
    }
...
/* Subroutine */ int iddr_id__(integer *m, integer *n, doublereal *a, integer 
	*krank, integer *list, doublereal *rnorms)
{
    ...
    extern /* Subroutine */ int iddr_qrpiv__(integer *, integer *, doublereal 
	    *, integer *, integer *, doublereal *), idd_lssolve__(integer *, 
...
/*       QR decompose a. */
    ...
    /* Function Body */
    iddr_qrpiv__(m, n, &a[a_offset], krank, &list[1], &rnorms[1]);
...
/* Subroutine */ int idd_reconid__(integer *m, integer *krank, doublereal *
...
/* Subroutine */ int idd_lssolve__(integer *m, integer *n, doublereal *a, 
	integer *krank)
{
    /* System generated locals */
    integer a_dim1, a_offset, i__1, i__2;
    ...
    extern /* Subroutine */ int idd_moverup__(integer *, integer *, integer *,
	     doublereal *);
...
/* k */
    idd_moverup__(m, n, krank, &a[a_offset]);
...
/* Subroutine */ int idd_moverup__(integer *m, integer *n, integer *krank, 
	doublereal *a)
{
    /* System generated locals */
    integer i__1, i__2;
...
/* Subroutine */ int idd_getcols__(integer *m, integer *n, S_fp matvec, 
...
/* Subroutine */ int idd_reconint__(integer *n, integer *list, integer *krank,
...
/* Subroutine */ int idd_copycols__(integer *m, integer *n, doublereal *a, 
