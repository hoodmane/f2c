...
/* Recursive Subroutine */ int dqng_(D_fp f, doublereal *a, doublereal *b, 
	doublereal *epsabs, doublereal *epsrel, doublereal *result, 
	doublereal *abserr, integer *neval, integer *ier)
{
    /* Initialized data */

    doublereal x1[5] = { .973906528517171720077964012084452,
    ...
    doublereal w87a[21] = { .00814837738414917290000287844819,
    ...
    doublereal w87b[23] = { 2.74145563762072350016527092881e-4,
    ...
    doublereal w10[5] = { .066671344308688137593568809893332,
    ...
    doublereal x2[5] = { .995657163025808080735527280689003,
    ...
    doublereal w21a[5] = { .03255816230796472747881897245939,
    ...
    doublereal w21b[6] = { .011694638867371874278064396062192,
    ...
    doublereal x3[11] = { .999333360901932081394099323919911,
    ...
    doublereal w43a[10] = { .016296734289666564924281974617663,
    ...
    doublereal w43b[12] = { .001844477640212414100389106552965,
    ...
    doublereal x4[22] = { .999902977262729234490529830591582,
