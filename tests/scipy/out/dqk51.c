...
/* Recursive Subroutine */ int dqk51_(D_fp f, doublereal *a, doublereal *b, 
	doublereal *result, doublereal *abserr, doublereal *resabs, 
	doublereal *resasc)
{
    /* Initialized data */

    doublereal wg[13] = { .011393798501026287947902964113235,
    ...
    doublereal xgk[26] = { .999262104992609834193457486540341,
    ...
    doublereal wgk[26] = { .001987383892330315926507851882843,
    ...
    /* Local variables */
    integer j = {0};
    doublereal fc = {0}, fv1[25] = {}, fv2[25] = {};
    integer jtw = {0};
    doublereal absc = {0}, resg = {0}, resk = {0}, fsum = {0}, fval1 = {0}, 
	    fval2 = {0};
    integer jtwm1 = {0};
