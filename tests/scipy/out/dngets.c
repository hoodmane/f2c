...
/*        %-------------------------------------------------------% */
	...
	i__1 = *kev + *np;
	dvout_(&logfil, &i__1, &ritzr[1], &ndigit, "_ngets: Eigenvalues of c"
		"urrent H matrix -- real part", (ftnlen)52);
	i__1 = *kev + *np;
	dvout_(&logfil, &i__1, &ritzi[1], &ndigit, "_ngets: Eigenvalues of c"
		"urrent H matrix -- imag part", (ftnlen)52);
	i__1 = *kev + *np;
	dvout_(&logfil, &i__1, &bounds[1], &ndigit, "_ngets: Ritz estimates "
