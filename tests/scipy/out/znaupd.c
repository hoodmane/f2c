	...
	doublereal *rwork, integer *info, ftnlen bmat_len, ftnlen which_len)
{
    ...
    static real tcaup2, tgetv0;
    extern /* Subroutine */ int znaup2_(integer *, char *, integer *, char *, 
    ...
    static real tcapps, tcconv, titref;
    static integer msglvl, mxiter, nrorth;
...
/*     %------------------------------------% */
	...
	*info = 3;
	...
	zvout_(&logfil, &np, &workl[ritz], &ndigit, "_naupd: The final Ritz "
		"values", (ftnlen)29);
	zvout_(&logfil, &np, &workl[bounds], &ndigit, "_naupd: Associated Ri"
