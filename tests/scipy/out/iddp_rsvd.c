...
/* Subroutine */ int iddp_rsvd__(integer *lw, doublereal *eps, integer *m, 
	...
	integer *iu, integer *iv, integer *is, doublereal *w, integer *ier)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int iddp_rid__(integer *, doublereal *, integer *,
	     integer *, U_fp, doublereal *, doublereal *, doublereal *, 
	    doublereal *, integer *, doublereal *, doublereal *, integer *);
    static integer k;
    extern /* Subroutine */ int iddp_rsvd0__(integer *, integer *, U_fp, 
...
/*       ID a. */
    ...
    lp = *lw - lw2;
    iddp_rid__(&lp, eps, m, n, (U_fp)matvect, p1t, p2t, p3t, p4t, krank, &w[
	    ilist], &w[iproj], ier);
    if (*ier != 0) {
	return 0;
    }
...
/* Computing 2nd power */
	...
	iddp_rsvd0__(m, n, (U_fp)matvect, p1t, p2t, p3t, p4t, (U_fp)matvec, 
...
/* Subroutine */ int iddp_rsvd0__(integer *m, integer *n, U_fp matvect, 
	...
	doublereal *col, doublereal *work)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int idd_id2svd__(integer *, integer *, doublereal 
	    *, integer *, integer *, doublereal *, doublereal *, doublereal *,
	     doublereal *, integer *, doublereal *), idd_getcols__(integer *, 
	    integer *, U_fp, doublereal *, doublereal *, doublereal *, 
...
/* Computing 2nd power */
    ...
    /* Function Body */
    idd_getcols__(m, n, (U_fp)matvec, p1, p2, p3, p4, krank, &list[1], &col[1]
	    , &work[1]);


/*       Convert the ID to an SVD. */

    idd_id2svd__(m, krank, &col[1], n, &list[1], &proj[proj_offset], &u[
