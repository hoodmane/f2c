...
/* Recursive Subroutine */ int fpopsp_(integer *ifsu, integer *ifsv, integer *
	ifbu, integer *ifbv, doublereal *u, integer *mu, doublereal *v, 
	integer *mv, doublereal *r__, integer *mr, doublereal *r0, doublereal 
	*r1, doublereal *dr, integer *iopt, integer *ider, doublereal *tu, 
	integer *nu, doublereal *tv, integer *nv, integer *nuest, integer *
	nvest, doublereal *p, doublereal *step, doublereal *c__, integer *nc, 
	...
	integer *nrv, doublereal *wrk, integer *lwrk)
{
    ...
    extern /* Recursive Subroutine */ int fpgrsp_(integer *, integer *, 
	    ...
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *,
	     integer *), fpsysy_(doublereal *, integer *, doublereal *);
