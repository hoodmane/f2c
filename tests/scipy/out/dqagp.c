...
/* Recursive Subroutine */ int dqagp_(D_fp f, doublereal *a, doublereal *b, 
	integer *npts2, doublereal *points, doublereal *epsabs, doublereal *
	epsrel, doublereal *result, doublereal *abserr, integer *neval, 
	integer *ier, integer *leniw, integer *lenw, integer *last, integer *
	iwork, doublereal *work)
{
    integer l1 = {}, l2 = {}, l3 = {}, l4 = {}, lvl = {}, limit = {};
    extern /* Recursive Subroutine */ int dqagpe_(D_fp, doublereal *, 
