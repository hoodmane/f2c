...
/* Recursive Subroutine */ int fppogr_(integer *iopt, integer *ider, 
	doublereal *u, integer *mu, doublereal *v, integer *mv, doublereal *
	z__, integer *mz, doublereal *z0, doublereal *r__, doublereal *s, 
	...
	doublereal *fpintv, doublereal *dz, doublereal *step, integer *lastdi,
	 integer *nplusu, integer *nplusv, integer *lasttu, integer *nru, 
