...
/* Recursive Subroutine */ int percur_(integer *iopt, integer *m, doublereal *
	x, doublereal *y, doublereal *w, integer *k, doublereal *s, integer *
	nest, integer *n, doublereal *t, doublereal *c__, doublereal *fp, 
