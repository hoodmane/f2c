...
/* Recursive Subroutine */ int curev_(integer *idim, doublereal *t, integer *
	n, doublereal *c__, integer *nc, integer *k, doublereal *u, integer *
	m, doublereal *x, integer *mx, integer *ier)
{
    ...
    /* Local variables */
    doublereal h__[6] = {};
    integer i__ = {0}, j = {0}, l = {0}, j1 = {0}, k1 = {0}, l1 = {0}, jj = {
	    0};
    doublereal tb = {0};
    integer ll = {0};
    doublereal te = {0};
