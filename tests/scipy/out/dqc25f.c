...
/* Recursive Subroutine */ int dqc25f_(D_fp f, doublereal *a, doublereal *b, 
	doublereal *omega, integer *integr, integer *nrmom, integer *maxp1, 
	integer *ksave, doublereal *result, doublereal *abserr, integer *
	neval, doublereal *resabs, doublereal *resasc, integer *momcom, 
	doublereal *chebmo)
{
    /* Initialized data */

    doublereal x[11] = { .991444861373810411144557526928563,
...
/* L140: */
	...
	*resabs = *resabs + (d__1 = cheb24[k - 1], abs(d__1)) + (d__2 = 
		cheb24[k], abs(d__2));
	k += -2;
/* L150: */
    }
