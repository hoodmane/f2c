...
/* Recursive Subroutine */ int dqaws_(D_fp f, doublereal *a, doublereal *b, 
	doublereal *alfa, doublereal *beta, integer *integr, doublereal *
	...
	last, integer *iwork, doublereal *work)
{
    ...
    extern /* Recursive Subroutine */ int dqawse_(D_fp, doublereal *, 
	    ...
	    integer *, doublereal *, doublereal *, doublereal *, doublereal *,
	     integer *, integer *), xerror_(char *, integer *, integer *, 
	    integer *, ftnlen);
