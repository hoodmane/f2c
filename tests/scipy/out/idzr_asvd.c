...
/* Subroutine */ int idzr_asvd__(integer *m, integer *n, doublecomplex *a, 
	...
	doublereal *s, integer *ier)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int idzr_asvd0__(integer *, integer *, 
...
/* Subroutine */ int idzr_asvd0__(integer *m, integer *n, doublecomplex *a, 
	...
	doublecomplex *col, doublecomplex *work)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int idzr_aid__(integer *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, integer *, 
	    doublecomplex *), idz_id2svd__(integer *, integer *, 
