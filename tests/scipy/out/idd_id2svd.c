...
/* Subroutine */ int idd_id2svd__(integer *m, integer *krank, doublereal *b, 
	...
	doublereal *v, doublereal *s, integer *ier, doublereal *w)
{
    ...
    extern /* Subroutine */ int idd_id2svd0__(integer *, integer *, 
...
/* Subroutine */ int idd_id2svd0__(integer *m, integer *krank, doublereal *b, 
	integer *n, integer *list, doublereal *proj, doublereal *u, 
	...
	doublereal *r3, integer *ind, integer *indt)
{
    ...
    /* Local variables */
    static integer j, k;
    extern /* Subroutine */ int idd_rearr__(integer *, integer *, integer *, 
	    integer *, doublereal *), idd_rinqr__(integer *, integer *, 
	    doublereal *, integer *, doublereal *), iddr_qrpiv__(integer *, 
	    integer *, doublereal *, integer *, integer *, doublereal *);
    static integer ldr, ldu;
    extern /* Subroutine */ int idd_qmatmat__(integer *, integer *, integer *,
	     doublereal *, integer *, integer *, doublereal *, doublereal *);
    static integer iftranspose, info;
    static char jobz[1];
    static integer ldvt;
    extern /* Subroutine */ int idd_reconint__(integer *, integer *, integer *
	    , doublereal *, doublereal *), idd_mattrans__(integer *, integer *
	    , doublereal *, doublereal *), idd_matmultt__(integer *, integer *
...
/* Subroutine */ int idd_mattrans__(integer *m, integer *n, doublereal *a, 
	doublereal *at)
{
    /* System generated locals */
...
/* Subroutine */ int idd_matmultt__(integer *l, integer *m, doublereal *a, 
...
/* Subroutine */ int idd_rearr__(integer *krank, integer *ind, integer *m, 
...
/* Subroutine */ int idd_rinqr__(integer *m, integer *n, doublereal *a, 
