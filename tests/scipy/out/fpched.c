...
/* Recursive Subroutine */ int fpched_(doublereal *x, integer *m, doublereal *
	t, integer *n, integer *k, integer *ib, integer *ie, integer *ier)
{
    /* System generated locals */
    integer i__1;

    /* Local variables */
    integer i__ = {0}, j = {0}, l = {0}, k1 = {0}, k2 = {0}, jj = {0};
    doublereal tj = {0}, tl = {0};
    integer ib1 = {0}, ie1 = {0}, nk1 = {0}, nk2 = {0}, nk3 = {0};
