...
/* Recursive Subroutine */ int fpsurf_(integer *iopt, integer *m, doublereal *
	x, doublereal *y, doublereal *z__, doublereal *w, doublereal *xb, 
	...
	integer *nummer, doublereal *wrk, integer *lwrk, integer *ier)
{
    ...
    extern /* Recursive Subroutine */ int fpdisc_(doublereal *, integer *, 
	    ...
	    *), fprank_(doublereal *, doublereal *, integer *, integer *, 
