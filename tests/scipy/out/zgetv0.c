	...
	doublecomplex *workd, integer *ierr, ftnlen bmat_len)
{
    ...
    static integer jj, nbx, iter;
    static logical orth;
    static integer nopx, iseed[4], idist;
    ...
    extern /* Subroutine */ int dvout_(integer *, integer *, doublereal *, 
	    ...
	    integer *, doublecomplex *, integer *), zvout_(integer *, integer 
    ...
    static integer logfil, ndigit, msglvl;
...
/*     %--------------------------------------% */
    ...
    if (msglvl > 2) {
	dvout_(&logfil, &c__1, &rnorm0, &ndigit, "_getv0: re-orthonalization"
		" ; rnorm0 is", (ftnlen)38);
	dvout_(&logfil, &c__1, rnorm, &ndigit, "_getv0: re-orthonalization ;"
		" rnorm is", (ftnlen)37);
    }
...
L50:
    ...
    if (msglvl > 0) {
	dvout_(&logfil, &c__1, rnorm, &ndigit, "_getv0: B-norm of initial / "
		"restarted starting vector", (ftnlen)53);
    }
    if (msglvl > 2) {
	zvout_(&logfil, n, &resid[1], &ndigit, "_getv0: initial / restarted "
