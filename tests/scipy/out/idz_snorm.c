...
/* Subroutine */ int idz_snorm__(integer *m, integer *n, S_fp matveca, 
	...
	snorm, doublecomplex *v, doublecomplex *u)
{
    ...
    static integer k, n2;
    extern /* Subroutine */ int idz_enorm__(integer *, doublecomplex *, 
	    doublereal *);
    static integer it;
...
/* Subroutine */ int idz_enorm__(integer *n, doublecomplex *v, doublereal *
	enorm)
{
    /* System generated locals */
    integer i__1, i__2;
...
/* Subroutine */ int idz_diffsnorm__(integer *m, integer *n, U_fp matveca, 
	doublecomplex *p1a, doublecomplex *p2a, doublecomplex *p3a, 
	...
	*snorm, doublecomplex *w)
{
    ...
    extern /* Subroutine */ int idz_diffsnorm0__(integer *, integer *, U_fp, 
...
/*       Allocate memory in w. */
    ...
    idz_diffsnorm0__(m, n, (U_fp)matveca, p1a, p2a, p3a, p4a, (U_fp)matveca2, 
...
/* Subroutine */ int idz_diffsnorm0__(integer *m, integer *n, S_fp matveca, 
	doublecomplex *p1a, doublecomplex *p2a, doublecomplex *p3a, 
