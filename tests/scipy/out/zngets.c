	...
	which_len)
{
    ...
    static integer logfil, ndigit, mcgets;
    static real tcgets;
...
/*        %-------------------------------------------------------% */
	...
	i__1 = *kev + *np;
	zvout_(&logfil, &i__1, &ritz[1], &ndigit, "_ngets: Eigenvalues of cu"
		"rrent H matrix ", (ftnlen)40);
	i__1 = *kev + *np;
	zvout_(&logfil, &i__1, &bounds[1], &ndigit, "_ngets: Ritz estimates "
