...
/* Recursive Subroutine */ int dqawc_(D_fp f, doublereal *a, doublereal *b, 
	doublereal *c__, doublereal *epsabs, doublereal *epsrel, doublereal *
	...
	limit, integer *lenw, integer *last, integer *iwork, doublereal *work)
{
    ...
    extern /* Recursive Subroutine */ int dqawce_(D_fp, doublereal *, 
