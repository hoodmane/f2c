...
/* Subroutine */ int ddet_c__(doublereal *det, doublereal *a, integer *n, 
...
/* Subroutine */ int ddet_r__(doublereal *det, doublereal *a, integer *n, 
	integer *piv, integer *info)
{
    /* System generated locals */
    ...
    /* Local variables */
    extern /* Subroutine */ int ddet_c__(doublereal *, doublereal *, integer *
	    , integer *, integer *);
...
/* f2py callprotoargument double*,double*,int*,int*,int* */
    ...
    /* Function Body */
    ddet_c__(det, &a[a_offset], n, &piv[1], info);
    return 0;
} /* ddet_r__ */

/* Subroutine */ int sdet_c__(real *det, real *a, integer *n, integer *piv, 
	integer *info)
{
    /* System generated locals */
    integer a_dim1, a_offset, i__1;
...
/* Subroutine */ int sdet_r__(real *det, real *a, integer *n, integer *piv, 
	integer *info)
{
    /* System generated locals */
    integer a_dim1, a_offset;
    ...
    /* Local variables */
    extern /* Subroutine */ int sdet_c__(real *, real *, integer *, integer *,
	     integer *);
...
/* f2py callprotoargument float*,float*,int*,int*,int* */
    ...
    /* Function Body */
    sdet_c__(det, &a[a_offset], n, &piv[1], info);
    return 0;
} /* sdet_r__ */

/* Subroutine */ int zdet_c__(doublecomplex *det, doublecomplex *a, integer *
...
/* Subroutine */ int zdet_r__(doublecomplex *det, doublecomplex *a, integer *
	n, integer *piv, integer *info)
{
    /* System generated locals */
    integer a_dim1, a_offset;
    ...
    /* Local variables */
    extern /* Subroutine */ int zdet_c__(doublecomplex *, doublecomplex *, 
	    integer *, integer *, integer *);
...
/* f2py callprotoargument complex_double*,complex_double*,int*,int*,int* */
    ...
    /* Function Body */
    zdet_c__(det, &a[a_offset], n, &piv[1], info);
    return 0;
} /* zdet_r__ */

/* Subroutine */ int cdet_c__(complex *det, complex *a, integer *n, integer *
	piv, integer *info)
{
    /* System generated locals */
    integer a_dim1, a_offset, i__1, i__2;
...
/* Subroutine */ int cdet_r__(complex *det, complex *a, integer *n, integer *
	piv, integer *info)
{
    /* System generated locals */
    integer a_dim1, a_offset;
    ...
    /* Local variables */
    extern /* Subroutine */ int cdet_c__(complex *, complex *, integer *, 
	    integer *, integer *);
...
/* f2py callprotoargument complex_float*,complex_float*,int*,int*,int* */
    ...
    /* Function Body */
    cdet_c__(det, &a[a_offset], n, &piv[1], info);
    return 0;
} /* cdet_r__ */
