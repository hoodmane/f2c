...
/* Recursive Subroutine */ int parsur_(integer *iopt, integer *ipar, integer *
	idim, integer *mu, doublereal *u, integer *mv, doublereal *v, 
	doublereal *f, doublereal *s, integer *nuest, integer *nvest, integer 
	...
	integer *kwrk, integer *ier)
{
    ...
    extern /* Recursive Subroutine */ int fpchec_(doublereal *, integer *, 
	    ...
	    integer *), fppasu_(integer *, integer *, integer *, doublereal *,
