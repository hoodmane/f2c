...
/* Recursive Subroutine */ int fpadpo_(integer *idim, doublereal *t, integer *
	n, doublereal *c__, integer *nc, integer *k, doublereal *cp, integer *
	np, doublereal *cc, doublereal *t1, doublereal *t2)
{
