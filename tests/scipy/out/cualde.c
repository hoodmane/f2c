...
/* Recursive Subroutine */ int cualde_(integer *idim, doublereal *t, integer *
	n, doublereal *c__, integer *nc, integer *k1, doublereal *u, 
	doublereal *d__, integer *nd, integer *ier)
{
