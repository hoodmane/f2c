...
/* Recursive Subroutine */ int fpspgr_(integer *iopt, integer *ider, 
	doublereal *u, integer *mu, doublereal *v, integer *mv, doublereal *
	r__, integer *mr, doublereal *r0, doublereal *r1, doublereal *s, 
	integer *nuest, integer *nvest, doublereal *tol, integer *maxit, 
	integer *nc, integer *nu, doublereal *tu, integer *nv, doublereal *tv,
	 doublereal *c__, doublereal *fp, doublereal *fp0, doublereal *fpold, 
	doublereal *reducu, doublereal *reducv, doublereal *fpintu, 
	doublereal *fpintv, doublereal *dr, doublereal *step, integer *lastdi,
	 integer *nplusu, integer *nplusv, integer *lastu0, integer *lastu1, 
	integer *nru, integer *nrv, integer *nrdatu, integer *nrdatv, 
