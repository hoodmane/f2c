...
/* Recursive Subroutine */ int r1mpyq_(integer *m, integer *n, doublereal *a, 
	integer *lda, doublereal *v, doublereal *w)
{
    /* Initialized data */
    ...
    /* Local variables */
    integer i__ = {0}, j = {0}, nm1 = {0}, nmj = {0};
    doublereal cos__ = {0}, sin__ = {0}, temp = {0};
