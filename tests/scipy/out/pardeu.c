...
/* Recursive Subroutine */ int pardeu_(doublereal *tx, integer *nx, 
	doublereal *ty, integer *ny, doublereal *c__, integer *kx, integer *
	ky, integer *nux, integer *nuy, doublereal *x, doublereal *y, 
	doublereal *z__, integer *m, doublereal *wrk, integer *lwrk, integer *
