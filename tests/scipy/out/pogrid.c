...
/* Recursive Subroutine */ int pogrid_(integer *iopt, integer *ider, integer *
	mu, doublereal *u, integer *mv, doublereal *v, doublereal *z__, 
	...
	integer *iwrk, integer *kwrk, integer *ier)
{
    ...
    extern /* Recursive Subroutine */ int fpchec_(doublereal *, integer *, 
	    ...
	    integer *), fppogr_(integer *, integer *, doublereal *, integer *,
