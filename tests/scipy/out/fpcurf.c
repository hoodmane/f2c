...
/* Recursive Subroutine */ int fpcurf_(integer *iopt, doublereal *x, 
	doublereal *y, doublereal *w, integer *m, doublereal *xb, doublereal *
	xe, integer *k, doublereal *s, integer *nest, doublereal *tol, 
	integer *maxit, integer *k1, integer *k2, integer *n, doublereal *t, 
	doublereal *c__, doublereal *fp, doublereal *fpint, doublereal *z__, 
	doublereal *a, doublereal *b, doublereal *g, doublereal *q, integer *
	nrdata, integer *ier)
{
