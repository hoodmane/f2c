	...
	workl, integer *ierr)
{
    ...
    extern /* Subroutine */ int sscal_(integer *, real *, real *, integer *), 
	    ...
	    real *, integer *, real *, real *, integer *), smout_(integer *, 
...
/*     %-------------------------------% */
    ...
    if (msglvl > 2) {
	smout_(&logfil, n, n, &h__[h_offset], ldh, &ndigit, "_neigh: Enterin"
...
/* L5: */
    ...
    if (msglvl > 1) {
	svout_(&logfil, n, &bounds[1], &ndigit, "_neigh: last row of the Sch"
...
/*     %------------------------------------------------% */
	...
	if ((r__1 = ritzi[i__], abs(r__1)) <= 0.f) {
...
/* L10: */
    ...
    if (msglvl > 1) {
	svout_(&logfil, n, &workl[1], &ndigit, "_neigh: Last row of the eige"
...
/*           %----------------------% */
	    ...
	    bounds[i__] = *rnorm * (r__1 = workl[i__], abs(r__1));
	} else {
...
/* L20: */
    ...
    if (msglvl > 2) {
	svout_(&logfil, n, &ritzr[1], &ndigit, "_neigh: Real part of the eig"
		"envalues of H", (ftnlen)41);
	svout_(&logfil, n, &ritzi[1], &ndigit, "_neigh: Imaginary part of th"
		"e eigenvalues of H", (ftnlen)46);
	svout_(&logfil, n, &bounds[1], &ndigit, "_neigh: Ritz estimates for "
