	...
	bounds, doublereal *q, integer *ldq, doublereal *workl, integer *ierr)
{
    ...
    extern /* Subroutine */ int dgemv_(char *, integer *, integer *, 
	    ...
	    doublereal *, doublereal *, integer *), dmout_(integer *, integer 
...
/*     %-------------------------------% */
    ...
    if (msglvl > 2) {
	dmout_(&logfil, n, n, &h__[h_offset], ldh, &ndigit, "_neigh: Enterin"
...
/* L5: */
    ...
    if (msglvl > 1) {
	dvout_(&logfil, n, &bounds[1], &ndigit, "_neigh: last row of the Sch"
...
/* L10: */
    ...
    if (msglvl > 1) {
	dvout_(&logfil, n, &workl[1], &ndigit, "_neigh: Last row of the eige"
...
/* L20: */
    ...
    if (msglvl > 2) {
	dvout_(&logfil, n, &ritzr[1], &ndigit, "_neigh: Real part of the eig"
		"envalues of H", (ftnlen)41);
	dvout_(&logfil, n, &ritzi[1], &ndigit, "_neigh: Imaginary part of th"
		"e eigenvalues of H", (ftnlen)46);
	dvout_(&logfil, n, &bounds[1], &ndigit, "_neigh: Ritz estimates for "
