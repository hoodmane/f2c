	...
	rwork, integer *ierr)
{
    ...
    extern /* Subroutine */ int zdscal_(integer *, doublereal *, 
	    doublecomplex *, integer *), zlahqr_(logical *, logical *, 
...
/*     %-------------------------------% */
    ...
    if (msglvl > 2) {
	zmout_(&logfil, n, n, &h__[h_offset], ldh, &ndigit, "_neigh: Enterin"
...
/*     %----------------------------------------------------------% */
    ...
    if (msglvl > 1) {
	zvout_(&logfil, n, &bounds[1], &ndigit, "_neigh: last row of the Sch"
...
/* L10: */
	...
	zvout_(&logfil, n, &workl[1], &ndigit, "_neigh: Last row of the eige"
...
/*     %----------------------------% */
    ...
    if (msglvl > 2) {
	zvout_(&logfil, n, &ritz[1], &ndigit, "_neigh: The eigenvalues of H", 
		(ftnlen)28);
	zvout_(&logfil, n, &bounds[1], &ndigit, "_neigh: Ritz estimates for "
