...
/* Recursive Subroutine */ int dqage_(D_fp f, doublereal *a, doublereal *b, 
	doublereal *epsabs, doublereal *epsrel, integer *key, integer *limit, 
	...
	*elist, integer *iord, integer *last)
{
    ...
    extern /* Recursive Subroutine */ int dqk21_(D_fp, doublereal *, 
	    ...
	    doublereal *, doublereal *, doublereal *, doublereal *), dqk41_(
	    D_fp, doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *), dqk15_(D_fp, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *), dqk51_(D_fp, doublereal *, doublereal *, 
