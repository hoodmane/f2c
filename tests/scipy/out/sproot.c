...
/* Recursive Subroutine */ int sproot_(doublereal *t, integer *n, doublereal *
	c__, integer *nc, doublereal *zero, integer *mest, integer *m, 
	integer *ier)
{
...
/*  calling sequence: */
/*     call sproot(t,n,c,nc,zero,mest,m,ier) */
