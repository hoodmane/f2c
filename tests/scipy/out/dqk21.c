...
/* Recursive Subroutine */ int dqk21_(D_fp f, doublereal *a, doublereal *b, 
	doublereal *result, doublereal *abserr, doublereal *resabs, 
	doublereal *resasc)
{
    /* Initialized data */

    doublereal wg[5] = { .066671344308688137593568809893332,
    ...
    doublereal xgk[11] = { .995657163025808080735527280689003,
    ...
    doublereal wgk[11] = { .011694638867371874278064396062192,
