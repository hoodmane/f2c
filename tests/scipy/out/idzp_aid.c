...
/* Subroutine */ int idzp_aid__(doublereal *eps, integer *m, integer *n, 
	...
	doublecomplex *proj)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int idzp_aid0__(doublereal *, integer *, integer *
	    , doublecomplex *, integer *, integer *, doublecomplex *, 
	    doublecomplex *), idzp_aid1__(doublereal *, integer *, integer *, 
	    integer *, doublecomplex *, integer *, integer *, doublecomplex *)
	    ;
    static integer n2;
    extern /* Subroutine */ int idz_estrank__(doublereal *, integer *, 
...
/*       Find the rank of a. */
    ...
    idz_estrank__(eps, m, n, &a[a_offset], &work[1], &kranki, &proj[1]);


    if (kranki == 0) {
	idzp_aid0__(eps, m, n, &a[a_offset], krank, &list[1], &proj[1], &proj[
		*m * *n + 1]);
    }

    if (kranki != 0) {
	idzp_aid1__(eps, &n2, n, &kranki, &proj[1], krank, &list[1], &proj[n2 
		* *n + 1]);
    }
...
/* Subroutine */ int idzp_aid0__(doublereal *eps, integer *m, integer *n, 
...
/* k */
    idzp_id__(eps, m, n, &proj[proj_offset], krank, &list[1], &rnorms[1]);
...
/* Subroutine */ int idzp_aid1__(doublereal *eps, integer *n2, integer *n, 
...
/* k */
    idzp_id__(eps, kranki, n, &proj[1], krank, &list[1], &rnorms[1]);
...
/* Subroutine */ int idz_estrank__(doublereal *eps, integer *m, integer *n, 
	doublecomplex *a, doublecomplex *w, integer *krank, doublecomplex *ra)
{
    ...
    extern /* Subroutine */ int idz_estrank0__(doublereal *, integer *, 
...
/*       Allocate memory in ra. */
    ...
    idz_estrank0__(eps, m, n, &a[a_offset], &w[1], &n2, krank, &ra[ira], &ra[
	    irat], &ra[iscal]);
...
/* Subroutine */ int idz_transposer__(integer *m, integer *n, doublecomplex *
	a, doublecomplex *at)
{
    /* System generated locals */
