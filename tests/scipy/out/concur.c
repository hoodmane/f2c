...
/* Recursive Subroutine */ int concur_(integer *iopt, integer *idim, integer *
	m, doublereal *u, integer *mx, doublereal *x, doublereal *xx, 
	doublereal *w, integer *ib, doublereal *db, integer *nb, integer *ie, 
	doublereal *de, integer *ne, integer *k, doublereal *s, integer *nest,
	 integer *n, doublereal *t, integer *nc, doublereal *c__, integer *np,
	...
	integer *iwrk, integer *ier)
{
    ...
    extern /* Recursive Subroutine */ int fpched_(doublereal *, integer *, 
	    ...
	    *), fpadpo_(integer *, doublereal *, integer *, doublereal *, 
	    ...
	    doublereal *, doublereal *), fpcons_(integer *, integer *, 
	    integer *, doublereal *, integer *, doublereal *, doublereal *, 
	    integer *, integer *, integer *, doublereal *, integer *, 
	    doublereal *, integer *, integer *, integer *, integer *, 
	    doublereal *, integer *, doublereal *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, integer *, integer *), fppocu_(integer *, integer *,
