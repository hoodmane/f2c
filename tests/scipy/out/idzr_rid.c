...
/* Subroutine */ int idzr_rid__(integer *m, integer *n, U_fp matveca, 
	...
	doublecomplex *p4, integer *krank, integer *list, doublecomplex *proj)
{
    ...
    extern /* Subroutine */ int idzr_ridall0__(integer *, integer *, U_fp, 
...
/*       Allocate memory in w. */
    ...
    idzr_ridall0__(m, n, (U_fp)matveca, p1, p2, p3, p4, krank, &list[1], &
...
/* Subroutine */ int idzr_ridall0__(integer *m, integer *n, S_fp matveca, 
	doublecomplex *p1, doublecomplex *p2, doublecomplex *p3, 
	...
	doublecomplex *x, doublecomplex *y)
{
    ...
    extern /* Subroutine */ int idzr_id__(integer *, integer *, doublecomplex 
...
/* j */
    idzr_id__(&l, n, &r__[r_offset], krank, &list[1], &y[1]);
