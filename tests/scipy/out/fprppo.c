...
/* Recursive Subroutine */ int fprppo_(integer *nu, integer *nv, integer *if1,
	 integer *if2, doublereal *cosi, doublereal *ratio, doublereal *c__, 
	doublereal *f, integer *ncoff)
{
